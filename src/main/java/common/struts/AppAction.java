...
public abstract class AppAction {
     ...
     */
    @RequestMapping
    public final String execute(HttpServletRequest request, HttpServletResponse response, Model model) throws Exception {
        // アクションフォームのインスタンス
        ActionForm form = (ActionForm) request.getAttribute(GS.REQUEST_ATTRIBUTE_STRUST_FORM_BEAN);
