...
/**
 *  OD1102_引当金確認 アクションフォームクラス<br>
 */
public class KakuninForm extends AppPagerActionForm {
	
	private static final long serialVersionUID = 1L; // serialVersionUID
	private boolean sateiKekkaBtnFlg;					// 査定結果ボタン表示用フラグ
	private String kanjyo_cd;							// 取引先コード
	private String kanjyo_nm;							// 取引先名
	private String shonin_tanto;						// 承認担当者
	private LinkedHashMap ar_shonin_tanto;				// 承認担当者【リスト】
	...
	private String zenki_saiken_zandaka_goukei;		// 債権残高合計①
	...
	private String kijun_saiken_zandaka_goukei;		// 債権残高合計①
	...
	private String hiddn_torihikisaki_kbn;				// 今期.取引先区分(チーク)
	private LinkedHashMap ar_konki_torihikisaki_kbn;	// 今期.取引先区分【リスト】
	private String konki_saiken_kbn;					// 今期.債権区分
	private String hiddn_saiken_kbn;					// 今期.債権区分(チーク)
	private LinkedHashMap ar_konki_saiken_kbn;			// 今期.債権区分【リスト】
	...
	private String konki_saiken_zandaka_goukei;		// 債権残高合計①
	...
	private String kijun_anken_no;						// 仮基準日.査定案件no.
	private String kijun_phase;						// 仮基準日.フェーズ
	private String jishi_phase;						// 実施フェーズ
	private String ji_jishi_phase;						// 次実施フェーズ
	private String ji_kaishi_status;					// 次開始ステータス
	// 課題No.28
	// 追加開始
	private LinkedHashMap ar_hikiatekin_shosai;	// 引当金詳細【リスト】
    ...
    public KakuninForm() {
        ...
        this.sateiKekkaBtnFlg = true;
        this.kanjyo_cd = GS.EMPTY_CHARCTER;
        this.kanjyo_nm = GS.EMPTY_CHARCTER;
        this.shonin_tanto = GS.EMPTY_CHARCTER;
        this.ar_shonin_tanto = null;
        ...
        this.hiddn_torihikisaki_kbn = GS.EMPTY_CHARCTER;
        this.ar_konki_torihikisaki_kbn = null;
        this.konki_saiken_kbn = GS.EMPTY_CHARCTER;
        this.hiddn_saiken_kbn = GS.EMPTY_CHARCTER;
        this.ar_konki_saiken_kbn = null;
    	...
    	// 課題No.28
    	// 追加開始
        this.ar_hikiatekin_shosai = null;
	...
	public LinkedHashMap getAr_shonin_tanto() {
		return ar_shonin_tanto;
	}
	public void setAr_shonin_tanto(LinkedHashMap ar_shonin_tanto) {
		this.ar_shonin_tanto = ar_shonin_tanto;
	}

	public String getKanjyo_cd() {
		return kanjyo_cd;
	}
	public void setKanjyo_cd(String kanjyo_cd) {
		this.kanjyo_cd = kanjyo_cd;
	}

	public String getKanjyo_nm() {
		return kanjyo_nm;
	}
	public void setKanjyo_nm(String kanjyo_nm) {
		this.kanjyo_nm = kanjyo_nm;
	}
	...
	public void setKijun_hikiate_taishou_kingaku(String kijun_hikiate_taishou_kingaku) {
	...
	public void setKijun_torihiki_maewatashie_kin(String kijun_torihiki_maewatashie_kin) {
	...
	public void setKonki_torihiki_maewatashie_kin(String konki_torihiki_maewatashie_kin) {
	...
	public String getShonin_tanto() {
		return shonin_tanto;
	}
	public void setShonin_tanto(String shonin_tanto) {
		this.shonin_tanto = shonin_tanto;
	}
	...
	public void setZenki_torihiki_maewatashie_kin(String zenki_torihiki_maewatashie_kin) {
	...
	public LinkedHashMap getAr_konki_saiken_kbn() {
		return ar_konki_saiken_kbn;
	}

	public void setAr_konki_saiken_kbn(LinkedHashMap ar_konki_saiken_kbn) {
		this.ar_konki_saiken_kbn = ar_konki_saiken_kbn;
	}

	public LinkedHashMap getAr_konki_torihikisaki_kbn() {
		return ar_konki_torihikisaki_kbn;
	}

	public void setAr_konki_torihikisaki_kbn(LinkedHashMap ar_konki_torihikisaki_kbn) {
		this.ar_konki_torihikisaki_kbn = ar_konki_torihikisaki_kbn;
	}

	public String getHiddn_saiken_kbn() {
		return hiddn_saiken_kbn;
	}

	public void setHiddn_saiken_kbn(String hiddn_saiken_kbn) {
		this.hiddn_saiken_kbn = hiddn_saiken_kbn;
	}

	public String getHiddn_torihikisaki_kbn() {
		return hiddn_torihikisaki_kbn;
	}

	public void setHiddn_torihikisaki_kbn(String hiddn_torihikisaki_kbn) {
		this.hiddn_torihikisaki_kbn = hiddn_torihikisaki_kbn;
	}
	...
	public boolean isSateiKekkaBtnFlg() {
		return sateiKekkaBtnFlg;
	}
	public void setSateiKekkaBtnFlg(boolean sateiKekkaBtnFlg) {
		this.sateiKekkaBtnFlg = sateiKekkaBtnFlg;
	}
	// 課題No.28
	// 追加開始
	public LinkedHashMap getAr_hikiatekin_shosai() {
		return ar_hikiatekin_shosai;
	}
	public void setAr_hikiatekin_shosai(LinkedHashMap ar_hikiatekin_shosai) {
		this.ar_hikiatekin_shosai = ar_hikiatekin_shosai;
	}
