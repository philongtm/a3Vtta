...
002		2016/04/06		SSC				部門廃止対応(二次) 
										引当金額集計表(査定結果)に「本部」列追加の為、
										明細出力最終列と印刷範囲最終列を変更
******************************************************************************/
package app.print.bss;

import app.print.dbAcc.SyukeiExcelDbAcc;
...
/**
 * LD2102 引当金額集計表（査定結果） ビジネスロジッククラス
 */
public class SyukeiExcelBss {
	...
	private static final String SHEETNAME_JA = "引当金集計表_期中";			// シート名
	private static final String SHEETNAME_EN = "Total0";						// シート名
	...
	private static final int endClm = 59;		//明細出力最終列
	private static final int printendClm = 49;	//印刷範囲最終列

	/**
	 * コンストラクタ
	 */
	public SyukeiExcelBss(AppContext appContext) throws Exception {
	...
	public void execute() throws Exception {
		...
		SyukeiExcelDbAcc dbacc = new SyukeiExcelDbAcc(sqlExec, log, appContext);
		//ヘッダ情報の取得 
