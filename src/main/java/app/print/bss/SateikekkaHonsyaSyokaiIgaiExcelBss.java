...
import app.print.dbAcc.SateikekkaHonsyaSyokaiIgaiExcelDbAcc;
...
/**
 * LD3102 引当金額集計表（初回月以外） ビジネスロジッククラス
 */
public class SateikekkaHonsyaSyokaiIgaiExcelBss {
	...
	private static final String TEMPLATE   = "LD3102";						// 使用テンプレート
	private static final String OUTFILENAME_JA = "引当金集計表(査定結果)(初回月以外).xls";		// 出力ファイル名
	private static final String OUTFILENAME_EN = "Total.xls";					// 出力ファイル名
	private static final String SHEETNAME_JA = "引当金額集計表(査定結果)(初回月以外)";			// シート名
	 ...
	 * コンストラクタ
	 */
	public SateikekkaHonsyaSyokaiIgaiExcelBss(AppContext appContext) throws Exception {
	...
	public void execute() throws Exception {
		...
		SateikekkaHonsyaSyokaiIgaiExcelDbAcc dbacc = new SateikekkaHonsyaSyokaiIgaiExcelDbAcc(sqlExec, log, appContext);
