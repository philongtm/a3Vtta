...
import app.print.dbAcc.SateikekkaHonsyaSyokaiExcelDbAcc;
...
/**
 * 引当金額集計表(査定結果)(本社用：初回月) ビジネスロジッククラス
 */
public class SateikekkaHonsyaSyokaiExcelBss {
	...
	private static final String TEMPLATE   = "LD3101";						// 使用テンプレート
	private static final String OUTFILENAME_JA = "引当金集計表(査定結果)(初回月).xls";		// 出力ファイル名
	private static final String OUTFILENAME_EN = "Total.xls";					// 出力ファイル名
	private static final String SHEETNAME_JA = "引当金額集計表(査定結果)(初回月)";			// シート名
	...
	private static final int printendClm = 61;

	/**
	 * コンストラクタ
	 */
	public SateikekkaHonsyaSyokaiExcelBss(AppContext appContext) throws Exception {
	...
	public void execute() throws Exception {
		...
		SateikekkaHonsyaSyokaiExcelDbAcc dbacc = new SateikekkaHonsyaSyokaiExcelDbAcc(sqlExec, log, appContext);
