...
<%--コンテンツ部分--%>
<DIV id="contents">
<H1 class="title01"><%=i18n.get(GL.TITLE_OB1105)%></H1>
...
<DIV id="list">
<html:form action="/tairyu/syoninsyosai">
	...
	<DIV class="headlist">
		...
		&nbsp;&nbsp;&nbsp;
		<DIV class="dottitle" style="width=9%; margin-top:2px;"><%=i18n.get(GL.OB1105_KANJO_NM)%></DIV><DIV class="ReadOnlybox" style="width=68%; margin-top:2px;"><bean:write name="TorihikisakiBean" property="kanjo_nm" /></DIV>
	...
	<DIV class="mainlist">
	<DIV id="tab"><span><%=i18n.get(GL.TITLE_OZ6101)%></span></DIV>
	<iframe src="../common/tairyu_meisai.jsp" width=100% height=800px>
	</DIV>
